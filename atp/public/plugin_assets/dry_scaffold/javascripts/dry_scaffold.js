...
function SetFormField(strFieldName, strFieldValue, form_id)
{
	if (strFieldName.length > 0)
	{
		...
		if (document.forms[form_id][strFieldName])
		{
			document.forms[form_id][strFieldName].value = strFieldValue;
...
function SubmitFormField(strFieldName, strFieldValue, form_id)
{
	SetFormField(strFieldName, strFieldValue, form_id);
	Submit(form_id);
}

function SubmitFormField2(strMenuAction, strFieldName, strFieldValue, strFieldName2, strFieldValue2)
{
	SetFormField(strFieldName2, strFieldValue2, form_id);
	SubmitFormField(strMenuAction, strFieldName, strFieldValue);
}

function SubmitFormField3(strMenuAction, strFieldName, strFieldValue, strFieldName2, strFieldValue2, strFieldName3, strFieldValue3)
{
	SetFormField(strFieldName3, strFieldValue3, form_id);
	SetFormField(strFieldName2, strFieldValue2, form_id);
	SubmitFormField(strMenuAction, strFieldName, strFieldValue);
}
