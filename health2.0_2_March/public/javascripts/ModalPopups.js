...
var ModalPopups = {
    ...
    _createAllLayers: function(id, title, message, parameters) {
        ...
        oPopupTitle.innerHTML = "<table cellpadding='0' cellspacing='0' style='border: 0;' height='100%'>" +
            "<tr><td valign='middle'><b>" + title + "</b><input type='image' src='/images/icons/cross.png' alt='hello' style='float:right' onclick='ModalPopups.Close(\"" + id + "\");'></td></tr>" + 
            "</table>" ;
    ...
    _styleAllLayers: function(id, parameters, allLayers) {
		...
		var cssBackground = "display:inline; position:absolute; z-index: " + (zIndex) + "; left:0px; top:0px; width:100%; height:325%; filter:alpha(opacity=70); opacity:0.7;";
